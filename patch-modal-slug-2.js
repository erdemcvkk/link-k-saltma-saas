...
const insertionPoint = `  const [isActive, setIsActive] = useState<boolean>(addon.isActive);`;
...
code = code.replace(insertionPoint, insertionPoint + slugFunction);
...
console.log("Patched addon-config-modal.tsx for specific slug!");
