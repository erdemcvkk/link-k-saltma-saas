...
export default function DashboardClient({
 ...
 <span className={`inline-flex items-center gap-1.5 px-3 py-2 rounded-full border text-[10px] font-bold uppercase tracking-wider ${
 ...
 {/* Top Header */}
 <div className={`flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 border-b pb-4 md:pb-6 ${
 "border-zinc-200"
 }`}>
 <div>
 ...
 className="flex items-center gap-2 px-3 sm:px-4 py-2.5 md:py-2 rounded-full text-xs font-bold transition-all border cursor-pointer whitespace-nowrap bg-slate-900 text-white hover:bg-slate-800 border-slate-900 shadow-sm"
 >
 ...
 <div className="flex justify-center py-2.5 md:py-2 bg-white rounded-xl p-3 border border-zinc-100">
 <QRCodeSVG
 value={qr.value}
 size={140}
 fgColor={qr.fgColor}
 ...
 className={`flex items-center justify-center gap-1.5 py-2.5 md:py-2 rounded-xl border font-bold text-[10px] transition-colors cursor-pointer ${
 ...
 className={`px-4 py-2.5 md:py-2 rounded-full border text-xs font-bold transition-all cursor-pointer ${
 "bg-white border-zinc-200 text-zinc-600 hover:bg-zinc-50"
 }`}
 >
 ...
 <span className={`inline-flex items-center gap-1.5 px-3 py-2 rounded-full border text-[9px] font-black uppercase tracking-wider ${
 "bg-white border-zinc-200 text-zinc-700 shadow-sm"
 }`}>
 ...
 className="flex-1 py-2.5 md:py-2 rounded-xl bg-zinc-900 hover:bg-zinc-800 text-white text-xs font-bold transition-colors shadow-sm flex items-center justify-center gap-2" 
 > 
 <Settings className="h-3.5 w-3.5" /> 
 ...
 className="flex-1 py-2.5 md:py-2 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white text-xs font-bold transition-colors shadow-sm flex items-center justify-center gap-2"
 >
 <Globe className="h-3.5 w-3.5" />
 ...
 <label className="px-4 py-2.5 md:py-2 rounded-lg bg-indigo-50 hover:bg-indigo-100 text-indigo-600 border border-indigo-100 text-[11px] font-bold transition-all cursor-pointer select-none">
 ...
 disabled={isPending}
 className="flex-1 py-2.5 rounded-lg bg-teal-500 hover:bg-teal-400 text-slate-900 text-[10px] font-black transition-colors cursor-pointer flex items-center justify-center gap-1 border-none"
 >
 ...
 className="px-2 py-2.5 rounded-lg border border-zinc-200 hover:bg-zinc-50 text-zinc-650 text-[9px] font-black cursor-pointer bg-white"
 >
 {lang === "tr" ? "Sıfırla" : "Reset"}
 </button>
 </div>
