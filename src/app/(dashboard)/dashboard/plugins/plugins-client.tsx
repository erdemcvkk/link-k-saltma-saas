...
export default function PluginsClient({
  ...
  const getAddonName = (type: string, lang: string) => {
    switch (type) {
      ...
      case "ELITE_TRAVEL": return lang === "tr" ? "Elite Seyahat (Bento Grid)" : "Elite Travel (Bento Box)";
      case "PREMIUM_PROFILE": return lang === "tr" ? "Premium Profil & Link Vitrini" : "Premium Profile & Link Hub";
  ...
  const getDefaultSlug = (type: string) => {
    ...
    if (type === "PREMIUM_PROFILE") return "premium-hub";
