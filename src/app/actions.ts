...
export async function seedTemplates(adminUserId?: string) {
  ...
  const sampleTemplates = [
    ...
    },
    {
      ...
      fontStyle: "Impact",
      buttonStyle: "bg-gradient-to-r from-red-600 to-indigo-650 text-white font-extrabold rounded-none shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:translate-x-0.5",
      isActive: true,
      isCoded: false,
    },
    {
