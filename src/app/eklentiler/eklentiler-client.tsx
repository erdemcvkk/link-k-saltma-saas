...
export default function EklentilerClient({ products, settings, userId = null }: EklentilerClientProps = {}) {
 ...
 <span>21 Premium Eklenti Vitrini</span>
 </div>
 ...
 İhtiyacınıza uygun modülü seçin, tek seferlik ödemeyle ömür boyu kullanın. 21 farklı premium eklenti ve tema arasından seçim yapın.
 </p>
 </div>
