...
export default function EklentilerClient({ products, settings, userId = null }: EklentilerClientProps = {}) {
 ...
 <span>16 Premium Eklenti Vitrini</span>
 </div>
 ...
 İhtiyacınıza uygun modülü seçin, tek seferlik ödemeyle ömür boyu kullanın. 16 farklı premium eklenti ve tema arasından seçim yapın.
 </p>
 </div>
