...
export default function PhonePreview({ mode, data, label, activeAddonId }: PhonePreviewProps) {
  ...
  const renderPluginPreview = () => {
    ...
    if (["PREMIUM_VIDEO", "SPOTIFY_CLASSIC", "VINYL_RETRO", "GLASS_AUDIO", "NEON_CYBERPUNK", "MUSIC_PODCAST", "PORTFOLIO_GALLERY", "COUNTDOWN_LAUNCH", "RETRO_CASSETTE", "AUDIO_PLAYER", "TRAVEL_STOREFRONT", "ELITE_TRAVEL"].includes(type)) {
