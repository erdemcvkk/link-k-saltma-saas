...
import { ShoppingBag, ChevronRight, Search, LayoutGrid, List } from "lucide-react";
...
export default function StorefrontPreview({ theme, products, storeTitle = "Digital Store", storeCoverUrl }: StorefrontPreviewProps) {
    ...
    switch (theme) {
      ...
      case "glassmorphism":
        return {
          ...
          headerBg: "bg-white/5 backdrop-blur-md border-b border-white/10",
          ...
          cardBg: "bg-white/5 border border-white/10 rounded-2xl backdrop-blur-md hover:bg-white/10 transition-all",
      ...
      case "minimalist":
        return {
          ...
          title: "text-zinc-900 font-medium tracking-tight",
          searchBg: "bg-zinc-50 border border-transparent focus-within:border-zinc-200 focus-within:bg-white rounded-lg",
          cardBg: "bg-white border border-zinc-100 rounded-lg hover:border-zinc-300 transition-colors shadow-none",
          ...
          badgeClass: "bg-zinc-100 text-zinc-600 border border-zinc-200 rounded-md",
        };
      case "vibrant-pop":
        return {
          wrapper: "bg-orange-50 text-orange-950 font-sans",
          headerBg: "bg-orange-100 border-b border-orange-200",
          title: "text-orange-900 font-black tracking-tight",
      ...
      <div className={`sticky top-0 z-10 ${styles.headerBg}`}>
        {storeCoverUrl && (
          <div className="w-full h-24 overflow-hidden relative">
            <img src={storeCoverUrl} className="w-full h-full object-cover" alt="Cover" />
            <div className="absolute inset-0 bg-black/20" />
          </div>
        )}
        <div className="p-4 text-center">
          <h3 className={`text-lg ${styles.title}`}>{storeTitle}</h3>
        </div>
